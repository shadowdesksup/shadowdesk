      ...
      <div className={`flex-1 flex flex-col gap-4 pr-2 w-full ${showPreview ? 'wide:max-w-[50%]' : ''} wide:overflow-y-auto custom-scrollbar`}>
        ...
        >
          <div className="grid grid-cols-1 xl:grid-cols-2 gap-6">
            {/* Period Filter - Full Width on mobile, spans 2 on larger screens if possible, but here spans full because of the new grid structure */}
            <div className="xl:col-span-2">
              ...
              <div className="flex flex-wrap gap-2 mt-5">
                <button
                  ...
                  className={`px-4 py-2 rounded-xl text-xs font-bold transition-all shadow-md whitespace-nowrap ${periodoSelecionado === 'mesPassado'
                ...
                <button
                  ...
                  className={`px-4 py-2 rounded-xl text-xs font-bold transition-all shadow-md whitespace-nowrap ${periodoSelecionado === 'mes'
                    ? theme === 'dark' ? 'bg-cyan-400/40 text-cyan-300 border border-cyan-400/60' : 'bg-cyan-500 text-white border-2 border-cyan-600'
                    : theme === 'dark'
                      ? 'bg-cyan-400/20 text-cyan-400 hover:bg-cyan-400/30 border border-cyan-400/40 shadow-cyan-400/20'
                      : 'bg-cyan-400/20 text-cyan-600 hover:bg-cyan-400/30 border border-cyan-400/30'
                ...
                <button
                  ...
                  className={`px-4 py-2 rounded-xl text-xs font-bold transition-all shadow-md whitespace-nowrap ${periodoSelecionado === 'semana'
                    ? theme === 'dark' ? 'bg-cyan-400/40 text-cyan-300 border border-cyan-400/60' : 'bg-cyan-500 text-white border-2 border-cyan-600'
                    : theme === 'dark'
                      ? 'bg-cyan-400/20 text-cyan-400 hover:bg-cyan-400/30 border border-cyan-400/40 shadow-cyan-400/20'
                      : 'bg-cyan-400/20 text-cyan-600 hover:bg-cyan-400/30 border border-cyan-400/30'
                ...
                <button
                  ...
                  className={`px-4 py-2 rounded-xl text-xs font-bold transition-all shadow-md whitespace-nowrap ${periodoSelecionado === 'ontem'
                    ? theme === 'dark' ? 'bg-cyan-400/40 text-cyan-300 border border-cyan-400/60' : 'bg-cyan-500 text-white border-2 border-cyan-600'
                    : theme === 'dark'
                      ? 'bg-cyan-400/20 text-cyan-400 hover:bg-cyan-400/30 border border-cyan-400/40 shadow-cyan-400/20'
                      : 'bg-cyan-400/20 text-cyan-600 hover:bg-cyan-400/30 border border-cyan-400/30'
                ...
                <button
                  ...
                  className={`px-4 py-2 rounded-xl text-xs font-bold transition-all shadow-md whitespace-nowrap ${periodoSelecionado === 'hoje'
                    ? theme === 'dark' ? 'bg-cyan-400/40 text-cyan-300 border border-cyan-400/60' : 'bg-cyan-500 text-white border-2 border-cyan-600'
                    : theme === 'dark'
                      ? 'bg-cyan-400/20 text-cyan-400 hover:bg-cyan-400/30 border border-cyan-400/40 shadow-cyan-400/20'
                      : 'bg-cyan-400/20 text-cyan-600 hover:bg-cyan-400/30 border border-cyan-400/30'
                ...
                <button
                  ...
                  className={`px-4 py-2 rounded-xl text-xs font-bold transition-all shadow-md whitespace-nowrap ${periodoSelecionado === 'todo'
