...
const EstoqueFluxoModal: React.FC<EstoqueFluxoModalProps> = ({
  isOpen, onClose, item, modo, onConfirmarTransferencia, onConfirmarDescarte, theme = 'dark', carregando = false, hidden = false
}) => {
  ...
  return (
    <EstoqueSidePanel isOpen={isOpen} onClose={onClose} title={titleNode} theme={theme} width="max-w-lg" hidden={hidden}>
      <form onSubmit={handleSubmit} className="p-6 flex flex-col gap-6">
        ...
        <div className="mt-6 flex justify-end gap-3">
          ...
          <button
            ...
            className={`px-6 py-2.5 text-white rounded-xl font-bold transition-transform shadow-lg shadow-black/20 flex items-center gap-2 disabled:opacity-70 disabled:scale-100 ${modo === 'TRANSFERENCIA'
