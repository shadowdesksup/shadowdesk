...
import { LayoutDashboard, PlusCircle, List, FileText, Settings, Ghost, User } from 'lucide-react';
...
const Sidebar: React.FC<SidebarProps> = ({ paginaAtual, onNavegar, theme = 'dark' }) => {
  const menuItems = [
  ...
  return (
    <motion.aside
      ...
      className={`flex w-64 flex-col gap-6 border-r backdrop-blur-md h-full transition-all duration-300 ${theme === 'dark'
